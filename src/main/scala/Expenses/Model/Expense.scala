...
object Expense {
  ...
  def createTravel(cost: Money, date: Date, from: String, to: String): ValidationResult[TravelExpense] =
  ...
  def createAccommodation(cost: Money, date: Date, hotel: String): ValidationResult[AccommodationExpense] =
  ...
  def createOther(cost: Money, date: Date, description: String): ValidationResult[OtherExpense] =
